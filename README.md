...
**SRv6 path insertion** to the P4 table is based on a **specyfic P4 code** from ngsdn-tutorial. Table name and its actions are hardcoded. 
If you want to create your own P4 code, please use the same [table](https://github.com/opennetworkinglab/ngsdn-tutorial/blob/advanced/solution/p4src/main.p4#L591) name and structure for setting SRv6 path or modyfi the **control_plane/node-manager/node_manager/srv6_mgr_linux.py** file.
